...
export default function MarketingPage() {
  const breadcrumbs = [{ name: "marketing", path: "/marketing" }]

  const marketingData = components.marketing
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <section className="bg-white py-12">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="mx-auto max-w-4xl text-center">
            <h1 className="text-4xl font-extrabold tracking-tight text-gray-900 sm:text-5xl">{marketingData.title}</h1>
            <p className="mt-4 text-lg text-gray-600">{marketingData.desc}</p>
          </div>
        </div>
      </section>
      ...
      <section className="py-12">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          {marketingData.sections.map((section) => (
