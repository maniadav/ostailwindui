...
export default function ApplicationUIPage() {
  const breadcrumbs = [{ name: "application ui", path: "/application-ui" }]

  const applicationUIData = components.applicationUI
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <section className="bg-white py-12">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="mx-auto max-w-4xl text-center">
            ...
            <p className="mt-4 text-lg text-gray-600">{applicationUIData.desc}</p>
          </div>
        </div>
      </section>
      ...
      <section className="py-12">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          {applicationUIData.sections.map((section) => (
